...
namespace Crm.Clients.Activities.Clients
{
    public class ActivityAttributeChangesClient : IActivityAttributeChangesClient
    {
        ...
        public ActivityAttributeChangesClient(IOptions<ActivitiesClientSettings> options,
        ...
        public Task<List<ActivityAttributeChange>> GetPagedListAsync(Guid? changerUserId = default,
            ...
            CancellationToken ct = default)
        {
            ...
            return _httpClientFactory.PostAsync<List<ActivityAttributeChange>>(
                $"{_settings.Host}/Api/Activities/Attributes/Changes/GetPagedList", parameter, ct);
        }
    }
}